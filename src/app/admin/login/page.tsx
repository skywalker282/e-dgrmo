    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-sm shadow-md">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <Link href="/admin/forgot-password" className="font-medium text-primary-blue hover:text-blue-700">
                Mot de passe oublié?
              </Link>
            </div>
          </div>
        ...
        <div className="text-center text-sm text-gray">
          <Link href="/" className="font-medium text-primary-blue hover:text-blue-700">
